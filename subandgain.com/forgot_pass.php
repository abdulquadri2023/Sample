...
<!-- Mirrored from subandgain.com/forgot_pass.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 15:00:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <base  >
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Forgot Password - SubAndGain</title>
                   ...
                   <div class="container-fluid">
						...
						<form id="contact-form" class="text-center" method="post">
								...
								<div class="col-md-12 text-center">
									<button class="btn" type="submit" name="recover"> Recover</button>
								</div>
									<div class="col-md-12 text-center"><br/>
									<p> <strong><a href="login.html">Login Here!</a></strong></p>
								</div>
