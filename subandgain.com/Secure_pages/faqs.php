...
<html lang="en">
    ...
    <link rel="stylesheet" href="css/style3.css">
       ...
       <!-- Font Awesome JS -->
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=h0WbeW3lMzw_7aPLSf302O1-22XhR026xHhuZ-FwXe3sJ6ItJ5Kbh0qVV4gaE--_vk5REHRXYLJ7SWcxJGpKhw" charset="UTF-8"></script><style>
...
<p> Below are the questions frequently asked by our members, find answers to all questions you want to ask.</p>
<br/>
             <p> <a href="javascript:toggleElement('a1','sag')" class="faq-content">&nbsp; <span id="sag"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; I've registered, how do I start buying?</a> </p>
<div id="a1" style="display: none;" class="hide_content"> 
 Log into your account, Fund your Wallet, Click on Menu, then Click on the product you want to buy and proceed.

</div>

 <p> <a href="javascript:toggleElement('a2','sag1')" class="faq-content">&nbsp; <span id="sag1"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; How do I Fund my Wallet?</a> </p>
<div id="a2" style="display: none;" class="hide_content">

    Login to your account, click on Fund Wallet button below your wallet balance, it will take you to the Fund Wallet page, select the method you want to use and input the amount you want to fund your wallet with. <br/>

You can fund your wallet by making a transfer to your unique account details or using your atm card to fund your wallet.  <br/>

Payment made through the two methods will reflect on your wallet instantly.
  </div>

  <p> <a href="javascript:toggleElement('a3','sag2')" class="faq-content">&nbsp; <span id="sag2"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; I paid online using my ATM card but my wallet was not credited instantly.</a> </p>
<div id="a3" style="display: none;" class="hide_content">
    Log into your account, Click on Menu, click on Wallet History, then click on Query for the particular transaction that was not autocredited into your wallet.  <br/>
    Your wallet will be funded immediately if the transaction was successful.
  </div>

  <p> <a href="javascript:toggleElement('a4','sag3')" class="faq-content">&nbsp; <span id="sag3"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; How will I know if the data I ordered for is delivered or not.</a> </p>
<div id="a4" style="display: none;" class="hide_content">
  Kindly query or check the status of the order to know if it is Pending, Approved or cancelled. Login into your account, click on Menu, click on Buy Data, then scroll down and click on Query for the particular order.  <br/>
If the status of the transaction is Approved, that means the transaction is under processing or delivered, but If the status of the transaction changed to cancelled, that means the data was not delivered to your customer and your wallet will be automatically refunded.
  </div>

  <p> <a href="javascript:toggleElement('a5','sag4')" class="faq-content">&nbsp; <span id="sag4"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; I ordered for data, the status has changed to Approved but I haven't received it.</a> </p>
<div id="a5" style="display: none;" class="hide_content">
   It's rare for this to happen. Kindly check your data balance by dialing the ussd code for checking data balance for the particular network you purchased, if you haven't still received it Kindly contact our customer care support and the issue will be rectified.
  </div>

   <p> <a href="javascript:toggleElement('a6','sag5')" class="faq-content">&nbsp; <span id="sag5"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; I registered and I didn't see my referral link on my dashboard.</a> </p>
<div id="a6" style="display: none;" class="hide_content">
    Free members are not eligible for our referral program. Kindly subscribe to Basic, Value, Premium, Diamond or Gold member to get your referral link.
  </div>


   <p> <a href="javascript:toggleElement('a7','sag6')" class="faq-content">&nbsp; <span id="sag6"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; How can I upgrade my Account?</a> </p>
<div id="a7" style="display: none;" class="hide_content">
    Log into your account, click on Upgrade Membership in your dashboard, Select the membership you want to upgrade to and then click on Upgrade.
  </div>

<p> <a href="javascript:toggleElement('a8','sag7')" class="faq-content">&nbsp; <span id="sag7"><i class='fa fa-plus'></i> </span>&nbsp;&nbsp; How does the referral program works?</a> </p>
<div id="a8" style="display: none;" class="hide_content">
    Kindly check the Referral Program page to know more about our referral program. Click <a href="../news.php"> <button type="submit" class="btnn btn-primary">HERE </button> </a>
  </div>
