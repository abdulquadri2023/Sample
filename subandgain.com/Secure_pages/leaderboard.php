...
<html lang="en">
    <head>
        ...
        <title>Leaderboard - SubAndGain</title>
    ...
    <link rel="stylesheet" href="css/style3.css">
       ...
       <!-- Font Awesome JS -->
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=GjnGKZZARgEVyZ64o7HPwBaAwruyKg-ZvnkthHJjLOWlhE_jQXNXI7G79IF1GEnMUe6zZrZ9UUG2CYIdyZ0luQ" charset="UTF-8"></script><style>
            ...
            <div class="col-md-12">
              <div class="panel panel-default sect-page">
                  <div class="sect-page panel-body">
                      <center><img src="../images/leaderboard.png" width="300"></center>
              <h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> WHAT IS LEADERBOARD? </b>
</h1>

<p> Leaderboard is a board showing the rank of leaders in our referral program. It is created to help all our members to grow in wealth and become more financially stable. As we are ready to be paying you monthly commission based on our leaderboard policy.</p>
            
             <h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> How does the leaderboard works? </b>
</h1>
<p> You will be paid a minimum of <b>&#8358;5,000</b> and maximum of <b>&#8358;100,000</b> every month once you refer atleast 10 subscribed members within the duration of each month. 
<br>This does not affect the 10% commission you will earn when they subscribe and also the commission you will earn whenever they made a transaction.</p>

<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> How much can I make within a month? </b>
</h1>
 <p>You can make up to <b>₦100,000</b> within a month.</p>
                                    <ul>
                                    <li> If you refer <b>10 Basic subscribers</b>, you will earn <b>₦500</b> on each subscriber which the total is <b>₦5,000</b>. </li>
                                    <li> If you refer <b>10 Value subscribers</b>, you will earn <b>₦1,000</b> on each subscriber which the total is <b>₦10000</b>. </li>
									<li> If you refer <b>10 Premium subscribers</b>, you will earn <b>₦1,500</b> on each subscriber which the total is <b>₦15,000</b>.</li>
									<li> If you refer <b>10 Diamond subscribers</b>, you will earn <b>₦2,000</b> on each subscriber which the total is <b>₦20,000</b>.</li>
									<li> If you refer <b>10 Gold subscribers</b>, you will earn <b>₦2,500</b> on each subscriber which the total is <b>₦25,000</b>.</li>
                                    <li> And also if you can refer up to <b>20 Gold subscribers</b>, you will earn <b>₦100,000</b> in total.</li>
                                    </ul>
<br/>
<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> How do I get paid? </b>
</h1>
<p> Once you have referred up to 10 subscribed members, your money will be added to your commission in your dashboard which you can withdraw to your bank account or use it to purchase any product.</p>

<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> How do I see my leaderboard earnings? </b>
</h1>
<p> You can see it in your dashboard. Log into your account, click on MENU, then click on My Leaderboard.  </p>

<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> Who is qualified in the leaderboard program? </b>
</h1>
<p> Only subscribed members are qualified in the leaderboard program. <b>Free members are not qualified</b>. </p>

<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> How many subscriber must I refer within a month? </b>
</h1>
<p> You must refer atleast <strong>10 subscribed members</strong> within a month before you can get paid for the leaderboard.</p>

<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b> What if I'm unable to refer up to 10 subscribers within a month? </b>
</h1>
<p>If your subscribed referrals are not up-to 10 before the month ends, all the learderboard money earned from those that you referred in that particular month will be automatically converted into Point Value(PV). And the conversion will be 10% of the amount earned. So if you earn ₦3,000 in your leaderboard within a month and you are unable to refer up-to 10 Subscribed Members, the ₦3,000 will be converted to 300PV which will be added to your Point Value. </p>
<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b>  Will I be paid if my referrals are Free Members?</b>
</h1>
<p>No. You will only be paid if your referrals are <b>Subscribed members</b>. </p>

<h1 class="page-title" style="color: #007bff; font-size: 22px;">
 <b>  When will I be paid?</b>
</h1>
 <p>Our payment for leaderboard is <b>12A.M</b> on the <b>1st</b> of each month.</p>
