...
<html lang="en">
    ...
    <link rel="stylesheet" href="css/style3.css">
       ...
       <!-- Font Awesome JS -->
    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=KPnPmKDUaEt6hZthAoy8VW0NdSL0vJwDZr-6P0abezCgPvCS_DZqPAc4m0xcqMuE47Ua0Uo88TKrY3UNPWHEvw" charset="UTF-8"></script><style>
      ...
      <div class="row">
      	<div class="col-md-12">
      		<div class="wrapper-content">
                  ...
                  To be an api user, kindly contact the admin to be upgraded to API User.<br/>
   		...
   		<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
   			<h6 class="m-0 font-weight-bold">   API Key </h6>
   		</div>
           ...
           <input type="button" class="btnn btn-primary" id="api_link" data-clipboard-text="" onclick="copyApi()" value="Copy Api Key">
           <input type="submit" class="btnn btn-primary" name="update" value="Generate New Key">
